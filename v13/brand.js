(function(){
  const extra={
    en:{
      brandName:'Triple E',brandRole:'Engineering Excellence Experts',eyebrow:'Senior-led integrated advisory',
      heroTitle:'Expert support where <span>business performance</span><br>and <span>project success</span> matter most.',
      heroText:'Triple E combines senior leadership, cross-functional judgement and coordinated multidisciplinary delivery across tendering, procurement, commercial management, project delivery and business improvement.',
      ...
      frameworkPromise:'Diagnose the gap. Structure the response. Deliver the action.',advisorName:'Mohamed Salaheldin',advisorRole:'Founder & Principal Advisor',advisorLine:'Every project is led directly by Mohamed Salaheldin and delivered as one coordinated multidisciplinary team with a single point of accountability.',
      ...
      exploreRelated:'Explore related solutions',footerBrand:'Triple E · Engineering Excellence Experts',footerLine:'Senior-led integrated advisory for the critical points where businesses and projects lose time, cost, control and opportunity.'
    },
    ar:{
      brandName:'Triple E',brandRole:'Engineering Excellence Experts',eyebrow:'استشارات بقيادة مباشرة وتنفيذ متكامل',
      heroTitle:'دعم خبير في النقاط الأكثر تأثيرًا على <span>أداء الأعمال</span><br>و<span>نجاح المشروعات</span>.',
      heroText:'يجمع Triple E بين القيادة المباشرة والخبرة المتكاملة والتنفيذ المنسق متعدد التخصصات في المناقصات والمشتريات والإدارة التجارية وإدارة المشروعات وتطوير الأعمال.',
      ...
      frameworkPromise:'نحدد الخلل، نبني الاستجابة المناسبة، ونحوّلها إلى خطوات تنفيذ.',advisorName:'محمد صلاح الدين',advisorRole:'المؤسس والمستشار الرئيسي',advisorLine:'يقود محمد صلاح الدين كل مشروع مباشرة، وتُدار مسارات العمل كفريق تنفيذ واحد متعدد التخصصات بمنهج موحد ومسؤولية واضحة أمام العميل.',
      ...
      exploreRelated:'استعرض الحلول المرتبطة',footerBrand:'Triple E · Engineering Excellence Experts',footerLine:'قيادة مباشرة وتنفيذ متكامل عند النقاط التي تخسر فيها الشركات والمشروعات الوقت أو التكلفة أو السيطرة أو الفرص.'
    }
  };
